...
@app.route('/api/models/<plan_id>', methods=['GET'])
...
@app.route('/api/checklists/<model_id>', methods=['GET'])
...
@app.route('/api/tasks/<checklist_id>', methods=['GET'])
...
@app.route('/api/content/<model_id>', methods=['GET'])
...
@app.route('/api/content/<model_id>', methods=['PUT'])
...
@app.route('/api/progress/<model_id>', methods=['PUT'])
    ...
    try:
        ...
        if children.data:
            ...
            if parent.data and parent.data[0].get('parent_model_id'):
                update_parent_progress(parent.data[0].get('parent_model_id'))
